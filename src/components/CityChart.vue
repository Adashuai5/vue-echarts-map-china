<template>
  <div class="chart" ref="chart" style="width: 1000px; height: 800px"></div>
</template>
...
const cityData = [
  { name: "海门", value: Math.round(Math.random() * 100) },
  { name: "鄂尔多斯", value: Math.round(Math.random() * 100) },
  { name: "招远", value: Math.round(Math.random() * 100) },
  ...
  { name: "乳山", value: Math.round(Math.random() * 100) },
  { name: "金昌", value: Math.round(Math.random() * 100) },
  { name: "泉州", value: Math.round(Math.random() * 100) },
  { name: "莱西", value: Math.round(Math.random() * 100) },
  { name: "日照", value: Math.round(Math.random() * 100) },
  { name: "胶南", value: Math.round(Math.random() * 100) },
  ...
  { name: "文登", value: Math.round(Math.random() * 100) },
  ...
  { name: "太仓", value: Math.round(Math.random() * 100) },
  { name: "曲靖", value: Math.round(Math.random() * 100) },
  { name: "烟台", value: Math.round(Math.random() * 100) },
  { name: "福州", value: Math.round(Math.random() * 100) },
  { name: "瓦房店", value: Math.round(Math.random() * 100) },
  { name: "即墨", value: Math.round(Math.random() * 100) },
  ...
  { name: "江阴", value: Math.round(Math.random() * 100) },
  { name: "蓬莱", value: Math.round(Math.random() * 100) },
  ...
  { name: "寿光", value: Math.round(Math.random() * 100) },
  ...
  { name: "胶州", value: Math.round(Math.random() * 100) },
  { name: "银川", value: Math.round(Math.random() * 100) },
  { name: "张家港", value: Math.round(Math.random() * 100) },
  ...
  { name: "宜兴", value: Math.round(Math.random() * 100) },
  { name: "北海", value: Math.round(Math.random() * 100) },
  { name: "西安", value: Math.round(Math.random() * 100) },
  { name: "金坛", value: Math.round(Math.random() * 100) },
  ...
  { name: "句容", value: Math.round(Math.random() * 100) },
  ...
  { name: "溧阳", value: Math.round(Math.random() * 100) },
  { name: "库尔勒", value: Math.round(Math.random() * 100) },
  ...
  { name: "临安", value: Math.round(Math.random() * 100) },
  ...
  { name: "富阳", value: Math.round(Math.random() * 100) },
  { name: "泰安", value: Math.round(Math.random() * 100) },
  { name: "诸暨", value: Math.round(Math.random() * 100) },
  ...
  { name: "义乌", value: Math.round(Math.random() * 100) },
...
export default {
  ...
  mounted() {
    this.cityData = this.convertData(cityData);
    if (!this.chart) {
      this.drawChinaMap();
    }
  },
